...
describe('Staff Registration', () => {
  describe('POST /api/register/staff', () => {
    it('should register staff with valid data', async () => {
      ...
      expect(response.body.message).toBe('University staff registration successful')
    ...
    it('should reject staff registration with missing department', async () => {
      ...
      expect(response.body.errors).toContain('All fields are required: name, surname, email, password, department')
    })
    ...
    it('should reject staff registration with short department', async () => {
      ...
      expect(response.body.success).toBe(false)
      expect(response.body.errors).toContain('Department must be at least 2 characters long')
    })
...
describe('Admin Registration', () => {
  describe('POST /api/register/admin', () => {
    ...
    it('should reject admin registration with missing name', async () => {
      ...
      expect(response.body.success).toBe(false)
      expect(response.body.message).toBe('Validation failed')
      expect(response.body.errors).toContain('All fields are required: name, surname, email, password')
    })
