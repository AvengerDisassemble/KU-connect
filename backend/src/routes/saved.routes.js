 ...
 */
router.get('/:user_id/saved', [validateUserId, handleValidationResult, authorizeUserIdParam], getSaved)

/**
 * POST /api/:user_id/saved
 */
router.post('/:user_id/saved', [validateUserId, validateJobIdInBody, handleValidationResult, authorizeUserIdParam], postSaved)

/**
 * DELETE /api/:user_id/saved
 */
router.delete('/:user_id/saved', [validateUserId, validateJobIdInBody, handleValidationResult, authorizeUserIdParam], deleteSaved)
