 ...
 * POST /:user_id/saved
 */
router.post('/saved', [validateUserId, validateJobIdInBody, handleValidationResult], postSaved)

/**
 * DELETE /:user_id/saved
 */
router.delete('/saved', [validateUserId, validateJobIdInBody, handleValidationResult], deleteSaved)
