...
router.post(
  ...
  documentsController.uploadResume,
);
router.get(
  "/resume/:userId/download",
  downloadRateLimit,
  documentsController.downloadResume,
);
...
router.post(
  "/transcript",
  role.roleMiddleware(["STUDENT"]),
  pdfUpload.single("transcript"),
  documentsController.uploadTranscript,
);
router.get(
  "/transcript/:userId/download",
  downloadRateLimit,
  documentsController.downloadTranscript,
);

// Employer verification routes (HR/employer only for upload)
router.post(
  "/employer-verification",
  role.roleMiddleware(["EMPLOYER"]),
  verificationUpload.single("verification"),
  documentsController.uploadEmployerVerification,
);
router.get(
  "/employer-verification/:userId/download",
  downloadRateLimit,
  documentsController.downloadEmployerVerification,
);
...
router.post(
  ...
  role.roleMiddleware(["STUDENT"]),
  verificationUpload.single("verification"),
  documentsController.uploadStudentVerification,
);
router.get(
  "/student-verification/:userId/download",
  downloadRateLimit,
  documentsController.downloadStudentVerification,
);
