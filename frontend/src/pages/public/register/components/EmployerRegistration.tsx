...
const step3Schema = z.object({
  ...
  phone: z
    .string()
    .regex(/^[0-9+\s\-()]*$/, "Phone number must contain only digits and valid separators")
...
const EmployerRegistration = () => {
  ...
  useEffect(() => {
    if (stepContainerRef.current) {
      const firstInput = stepContainerRef.current.querySelector<HTMLInputElement | HTMLButtonElement>('input, button');
      if (firstInput) {
  ...
  if (isSubmitted) {
    return (
      <div className="space-y-6 py-8 text-center animate-fade-in" role="status" aria-live="polite">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Your employer account has been created. You can browse jobs while we verify your company information.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6" role="region" aria-label="Employer registration form">
      <div className="sr-only" role="status" aria-live="polite" aria-atomic="true">
        {Object.keys(errors).length > 0 && "Form has errors. Please review and correct."}
        Step {currentStep} of 3
      </div>
      {/* Progress Indicator */}
      <div className="space-y-2" role="group" aria-label="Registration progress">
        <div className="flex justify-between text-sm font-medium">
          <span className="text-muted-foreground" aria-label={`Current step: ${currentStep} of 3`}>
            Step {currentStep} of 3
          </span>
          <span className="text-primary" aria-label={`${Math.round(progress)} percent complete`}>
            {Math.round(progress)}% Complete
          </span>
        </div>
        <Progress value={progress} className="h-2" aria-label="Overall progress" />
      </div>
      ...
      {currentStep === 2 && (
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Tell us about your organization. Company name and address are required for verification.
          </p>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`h-11 sm:h-12 ${errors.companyName ? "border-destructive" : ""}`}
          ...
          <div className="space-y-2">
            <Label htmlFor="address" className="text-sm sm:text-base">Company Address</Label>
            <Textarea
              id="address"
          ...
          <div className="space-y-2">
            <Label htmlFor="logo" className="text-sm sm:text-base">Company Logo</Label>
            <div 
          ...
          <div className="space-y-2">
            ...
            />
            <p id="description-count" className="text-xs text-muted-foreground text-right">
      ...
      {currentStep === 3 && (
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Optional: Share contact details and supporting documents to speed up verification.
          </p>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`h-11 sm:h-12 ${errors.contactEmail ? "border-destructive" : ""}`}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`h-11 sm:h-12 ${errors.phone ? "border-destructive" : ""}`}
          ...
          <div className="space-y-2">
            <Label htmlFor="website" className="text-sm sm:text-base">Website (Optional)</Label>
            <Input
              id="website"
              type="url"
              ...
              className={`h-11 sm:h-12 ${errors.website ? "border-destructive" : ""}`}
